...
<div class="tab_content" id="tab2_content">
  <div class="content_nav">
    ...
    @endif
    {{-- 新規作成ボタン --}}
    <button type="button" class="btn btn_add_item" onclick="showProductWindow()">新規作成</button>
  </div>
  {{-- コンテンツ --}}
  <div class="data_list">
  ...
  {{-- 新規作成用ウィンドウ --}}
  <div id="window_backframe" class="window_backframe @if(empty(old('new_image_open')) && empty(old('new_genre_open')) && empty(old('new_area_open')) && empty(old('new_product_open'))) is-hidden @endif">
    <div class="window_background" onclick="hideWindow()"></div>
    <div class="window">
  
      @include('layouts.contents.new_product')
